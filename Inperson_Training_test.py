...
click = driver.find_element_by_xpath("//a[@href='https://linuxjobber.com/homes/liveinstructor']")
click.click()

buy = driver.find_element_by_xpath("//a[@href='https://linuxjobber.com/homes/attendrequest']")
buy.click()
...
# select = driver.get("https://linuxjobber.com/tutorials/insertest/basics_of_linux_lectures")
#
...
#
#
# choose = driver.get("https://linuxjobber.com/tutorials/insertest/basics_of_linux_lectures")
#
#
